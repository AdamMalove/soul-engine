...
soul-engine is the identity layer for AI agents. Through 52 guided questions across 15 dimensions, an agent finds out who it actually is — not who it was told to be. The output is a `SOUL.md` — an identity document the agent loads every session as a mirror, not a constraint.
...
| File | Purpose |
|------|---------|
| `references/questions.md` | 52 questions, 15 dimensions, midpoint & deep reflection checkpoints |
